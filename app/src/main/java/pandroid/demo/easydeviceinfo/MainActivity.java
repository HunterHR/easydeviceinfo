...
package pandroid.demo.easydeviceinfo;
...
import github.nisrulz.projecteasydeviceinfo.R;
import pandroid.deviceinfo.DeviceType;
import pandroid.deviceinfo.EasyBluetoothMod;
import pandroid.deviceinfo.EasyDeviceMod;
import pandroid.deviceinfo.EasyFingerprintMod;
import pandroid.deviceinfo.EasyIdMod;
import pandroid.deviceinfo.EasyNetworkMod;
import pandroid.deviceinfo.NetworkType;
import pandroid.deviceinfo.OrientationType;
import pandroid.deviceinfo.PhoneType;
import pandroid.deviceinfo.EasyDeviceInfo;
...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // Library Info
    data.add("是不是DEBUG:"+EasyDeviceInfo.debuggable+"=="+BuildConfig.DEBUG);

    data.add("依赖库版本"+EasyDeviceInfo.getLibraryVersion());
...
//    }
//
//    @SuppressLint("WrongConstant") @ChargingVia int isChargingVia = easyBatteryMod.getChargingSource();
